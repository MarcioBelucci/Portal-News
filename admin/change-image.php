...
if(isset($_POST['update'])) {
   ...
   $query=mysqli_query($mysqli,"UPDATE posts SET PostImage = '".$imgnewfile."' WHERE id='$postid'");
   if($query)
   {
   $msg="Imagem de destaque atualizada";
   }
   else{
            ...
            <div class="content">
               <div class="container">
                  ...
                  <div class="row">
                     <div class="col-sm-6">
                        ...
                        <div class="alert alert-success" role="alert">
                           <strong>Feito!</strong> <?php echo htmlentities($msg);?>
                        </div>
                        <?php } ?>
                        <!---Error Message--->
                        <?php if($error){ ?>
                        <div class="alert alert-danger" role="alert">
                           <strong>Deu erro!</strong> <?php echo htmlentities($error);?>
                        </div>
                        <?php } ?>
                     </div>
                  </div>
                  <form name="addpost" method="post" enctype="multipart/form-data">
                     <?php
                        $postid=intval($_GET['pid']);
                        $query=mysqli_query($mysqli,"SELECT PostImage,PostTitle FROM posts WHERE id='$postid' AND Is_Active=1 ");
