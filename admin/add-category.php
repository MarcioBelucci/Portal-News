...
if(isset($_POST['submit'])) {
   ...
   $query = 'INSERT INTO category(CategoryName, Description, Is_Active) VALUES("'.$category.'", "'.$description.'", 1)';
   ...
   {
      $error = 'O nome precisa ter pelo menos 2 caracteres com a 1ª letra maiuscula e a descrição precisa ter pelo menos 15 caracteres.';
   }
