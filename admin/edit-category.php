...
if(isset($_POST['submit'])){
   ...
   $query = mysqli_query($mysqli,'UPDATE category SET CategoryName = "'.$category.'", Description = "'.$description.'", UpdationDate = Now()  WHERE id = '. $cid .'');
   if($query){
                     ...
                     <div class="col-sm-12">
                        <div class="card-box">
                           ...
                           <?php 
                              //notícias
                              if (isset($_GET['cid'])){
                                 $select = mysqli_query($mysqli, 'SELECT CategoryName, Description, PostingDate, UpdationDate FROM category WHERE Is_Active = 1 AND id = '. $_GET['cid'] . '');
                              }
