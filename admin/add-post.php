...
if(isset($_POST['submit']))
{
   ...
   {
   echo "<script>Formato Inválido. Somente jpg / jpeg/ png /gif são permitidos');</script>";
   }
   else
   {
   ...
   $query=mysqli_query($mysqli,"insert into posts(PostTitle,CategoryId,PostDetails,PostUrl,Is_Active,PostImage) values('$posttitle','$catid','$postdetails','$url','1','$imgnewfile')");
   if($query)
   {
                                 ...
                                 <div class="form-group m-b-20">
                                    ...
                                    <select class="form-control" name="category" id="category" required>
                                       ...
                                       <?php
                                          ...
                                          $ret=mysqli_query($mysqli,"SELECT id,CategoryName FROM category WHERE Is_Active=1");
